...
public class RedeemController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (customer == null) {
            response.sendRedirect(request.getContextPath() + "/login?returnUrl=/redeem");
            return;
        }
        preparePage(request, customer);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        preparePage(request, refreshedCustomer == null ? customer : refreshedCustomer);
        request.getRequestDispatcher("/jsp/customer/redeem.jsp").forward(request, response);
    }
